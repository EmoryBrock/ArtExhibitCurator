            ...
            <div className="md:flex md:items-center md:gap-12">
              <nav aria-label="Global" className="hidden md:block">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <Link className="text-grey-500 transition hover:text-red-500/75" to="/search"> Search </Link>
                  </li>
                  {isLoggedIn ? (
                    <>
                      <li>
                        <Link className="text-grey-500 transition hover:text-red-500/75" to={`/collection/${currentUser.displayName}`}>My Exhibits </Link>
                      </li>
                      {/* <li>
